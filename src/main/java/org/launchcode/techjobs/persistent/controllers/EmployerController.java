...
public class EmployerController {
    ...
    // However, it doesn’t yet contain the code to save a valid object. Use employerRepository and the appropriate method to do so.
    @PostMapping("add")
    ...
    // optEmployer is currently initialized to null. Replace this using the .findById() method with
